...
public class GBMTrainApp extends AbstractH2O {
    private final static Logger LOGGER = LoggerFactory.getLogger(GBMTrainApp.class);
    ...
    public static void train(String train, int ntrees, int max_depth, String when) {
        try {
            ...
            String[] ignoredColumns = { "Group", "EventTime", "EventIndex", "DTA", "TTATA", "Fraction" };
            ...
            final String modelname = "GBM_" + ntrees + "_" + max_depth;
